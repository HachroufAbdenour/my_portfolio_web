...
class PersonalInfoComponent extends StatelessWidget {
  ...
  final String whatsappUrl = 'https://wa.me/+213';
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Text(
            ...
            "A skilled flutter developer with over 2 years of experience, you can contact me at any time to start a work full of creativity and good performance",
          ...
          children: [
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchEmail(
                      toEmail: "eng.hachrouf.abdenour@gmail.com",
                      body: "",
                      subject: "");
                },
                child: Text(
